...
public class GenerateParsingTree {
    ...
    public ParsingTree generate(TerminalString terminalString, CFGrammar cfGrammar) {
        2 =
                3
                =
    ...
    private ParsingTree deriveStrings(Variable variable, TerminalString terminalString) {
